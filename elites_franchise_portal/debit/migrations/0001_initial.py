    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount_recorded', models.FloatField(blank=True, null=True)),
                ('removal_type', models.CharField(blank=True, choices=[('SALES', 'SALES'), ('DAMAGES', 'DAMAGES'), ('RETURNS', 'RETURNS'), ('SUPPLIES', 'SUPPLIES'), ('INVENTORY', 'INVENTORY')], max_length=300, null=True)),
                ('closing_stock_quantity', models.FloatField(blank=True, default=0, null=True)),
