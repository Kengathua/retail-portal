...
class DataPartitionMixin(object):
    """Determines what data to return based on user's franchise organisation."""
    ...
    def get_queryset(self):
        ...
        franchise_spec = partition_spec.get(franchise.partnership_type, None)
        if franchise_spec is None:
            return queryset.none()
