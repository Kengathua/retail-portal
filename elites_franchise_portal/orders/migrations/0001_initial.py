    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='debit.sale')),
            ],
            options={
                'ordering': ['-created_on'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_of_items_without_deposit', models.IntegerField(blank=True, null=True)),
                ('cart_item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='orders.cartitem')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='orders.order')),
            ],
            options={
