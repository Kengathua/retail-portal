...
import elites_retail_portal.orders.models.orders
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instant_order_items_total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=30, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('installment_order_items_total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=30, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('order_total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=30, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.UUIDField()),
                ('enterprise', models.CharField(max_length=250)),
                ('order_transaction_code', models.CharField(default=elites_retail_portal.orders.models.orders.create_order_transaction_code, max_length=300)),
                ('order_transaction_name', models.CharField(default=elites_retail_portal.orders.models.orders.create_order_transaction_name, max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=30, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_cleared', models.BooleanField(default=False)),
                ('is_canceled', models.BooleanField(default=False)),
                ('total_installments', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=30, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('deposit_amount', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=30, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('installment_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='orders.installmentsorderitem')),
                ('order_transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.ordertransaction')),
            ],
            options={
